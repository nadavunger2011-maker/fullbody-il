          ...
          <div className="p-5 space-y-5">
            ...
            <div className="bg-muted/60 rounded-xl p-4 space-y-3">
              <p className="text-foreground text-sm leading-relaxed text-right">
                הרשו לי לעזור לכם להשיג את מטרותיכם - ללקוחות יש סיכוי טוב יותר להשיג את מטרותיהם עם המוצרים הנכונים, מערכת יחסים עם הרב-לייף העצמאי שלהם, ולהיות חלק מקהילה. אם ברצונכם לקבל תמיכה מותאמת אישית להשגת מטרותיכם, אנא צרו עמי קשר בשימוש בפרטים לעיל.
              </p>
            </div>
