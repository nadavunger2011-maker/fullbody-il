              ...
              <>
                {filteredProducts.slice(0, 8).map((product, index) => (
                  <div 
                    ...
                    style={{ animationDelay: `${index * 0.05}s` }}
                  >
                    <Link href="https://fullbody-new.myshopify.com/products/${product.node.handle}" className="relative overflow-hidden aspect-square bg-secondary/30 block cursor-pointer flex items-center justify-center p-6">
                    ...
                    <div className="p-3 sm:p-5 flex-1 flex flex-col">
                      <Link href="https://fullbody-new.myshopify.com/products/${product.node.handle}" className="font-bold text-sm sm:text-lg text-foreground mb-1 sm:mb-2 group-hover:text-accent transition-colors hover:underline">
                  ...
                  {filteredProducts.length > 0 ? (
                    <div className="space-y-2">
                      {filteredProducts.slice(0, 5).map(product => (
                        <Link 
                          key={product.node.id}
                          href="https://fullbody-new.myshopify.com/products/${product.node.handle}"
