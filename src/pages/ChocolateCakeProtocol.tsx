...
export default function ChocolateCakeProtocol() {
  ...
  return (
    <div dir="rtl" lang="he" className="min-h-screen bg-black text-white antialiased">
      <Helmet>
      ...
      <article className="mx-auto max-w-3xl px-5 py-10 sm:py-16">
        ...
        <header className="mb-10 sm:mb-14">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-3 py-1 text-[11px] uppercase tracking-[0.2em] text-[#d4af37]">
            פרוטוקול בלעדי
          </div>
        ...
        {/* Macros card */}
        <section className="mb-8 rounded-2xl border border-white/10 bg-gradient-to-b from-white/[0.04] to-transparent p-5 sm:p-7">
        ...
        <section className="mb-2">
          <h2 className="text-sm font-semibold uppercase tracking-[0.2em] text-white/60 mb-4">
            המרכיבים
          </h2>
          <ul className="space-y-3 select-none pointer-events-none">
            {ingredients.map((ing, i) => (
              <li key={i} className="flex items-start gap-3 rounded-xl border border-white/10 bg-white/[0.03] p-4">
                <span className="mt-0.5 inline-block h-5 w-5 rounded border border-white/30 bg-transparent flex-shrink-0" />
                <span className="text-white/90 text-[15px] leading-snug">{ing}</span>
              </li>
            ))}
          </ul>
        </section>
        ...
        {/* Gated wall */}
        <section className="relative mt-4 overflow-hidden rounded-2xl border border-white/10 bg-[#0a0a0a] p-6 sm:p-10 shadow-[0_30px_80px_-30px_rgba(0,0,0,0.9)]">
          ...
          <div className="relative">
            ...
            <p className="mx-auto mt-4 max-w-xl text-center text-sm sm:text-base text-white/65 leading-relaxed">
            ...
            <form onSubmit={handleSubmit} className="mx-auto mt-7 max-w-md space-y-3">
              <Input
                ...
                className="h-12 rounded-xl border-white/15 bg-white/5 text-white placeholder:text-white/30 focus-visible:border-[#d4af37] focus-visible:ring-[#d4af37]/30"
              />
              <Button
                type="submit"
                disabled={loading}
              ...
              <p className="pt-2 text-center text-[11px] text-white/40 leading-relaxed">
        ...
        {/* Disclaimer */}
        <footer className="mt-12 border-t border-white/10 pt-6 text-center text-[11px] text-white/40 leading-relaxed">
