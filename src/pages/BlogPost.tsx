            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                {relatedProducts.map((product, index) => (
                  ...
                  >
                    <Link href="https://checkout.fullbody.co.il/products/${product.node.handle}" className="block">
                    ...
                    <div className="p-3 sm:p-4">
                      <Link href="https://checkout.fullbody.co.il/products/${product.node.handle}">
